class AddMocaAlternateTable < ActiveRecord::Migration[5.2]
  def change
    create_table :moca_alternate_form_rows do |t|
    ...
    add_column :assessments, :moca_alternate, :boolean, default: false
  end
end
